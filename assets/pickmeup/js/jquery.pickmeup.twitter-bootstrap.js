  ...
  (function ($) {
    $.fn.pickmeup_twitter_bootstrap = function (initial_options) {
      return this.each(function () {
        ...
        return $(this.__pickmeup.element)
